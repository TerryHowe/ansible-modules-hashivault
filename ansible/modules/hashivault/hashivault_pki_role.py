        ...
        suboptions:
            ttl:
                ...
                description:
                    ...
                    - If not set, uses the system default value or the value of C(max_ttl), whichever is shorter.
            max_ttl:
                type: str
                description:
            ...
            allowed_domains:
                ...
                description:
                    ...
                    - This is used with the C(allow_bare_domains) and C(allow_subdomains) options.
            allow_bare_domains:
                type: bool
                default: false
                description:
            ...
            allow_glob_domains:
                ...
                default: false
                description:
                    - Allows names specified in C(allowed_domains) to contain glob patterns (e.g. C(ftp*.example.com))
            ...
            allowed_uri_sans:
                ...
                description:
                    ...
                    - Values can contain glob patterns (e.g. C(spiffe://hostname/*)).
            allowed_other_sans:
                type: str
                description:
            ...
            key_bits:
                ...
                description:
                    ...
                    - This will need to be changed for C(ec) keys, e.g., 224 or 521.
            key_usage:
                type: list
            ...
            require_cn:
                ...
                default: true
                description:
                    - If set to false, makes the C(common_name) field optional while generating a certificate.
            policy_identifiers:
                type: list
                description:
