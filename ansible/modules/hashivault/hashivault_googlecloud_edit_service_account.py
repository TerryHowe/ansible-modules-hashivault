...
def main():
    ...
    result = hashivault_googlecloud_edit_service_account(module)
...
@hashiwrapper
def hashivault_googlecloud_edit_service_account(module):
    ...
    client.auth.gcp.edit_service_accounts_on_iam_role(mount_point=mount_point, role_name=role_name, **desired_state)
